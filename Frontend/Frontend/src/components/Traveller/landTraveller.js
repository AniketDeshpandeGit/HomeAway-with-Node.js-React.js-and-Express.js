...
import LoginTraveller from "./LoginTraveller";
import CreateTraveller from "./CreateTraveller";

class landTraveller extends Component {
  constructor(props) {
  ...
  render() {
    ...
    if (this.state.selectedOption === "login") {
      console.log("Inside Login");
      setForm = <LoginTraveller />;
    } else if (this.state.selectedOption === "signUp") {
      console.log("Inside SignUp");
      setForm = <CreateTraveller />;
    }
